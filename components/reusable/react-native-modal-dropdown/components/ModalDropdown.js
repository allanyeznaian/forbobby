...
import { modalDropdown, global } from "../../../../Styles/Styles";
...
export default class ModalDropdown extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      width: !this.props.width
        ? Math.round(Dimensions.get("window").width) / 3.5
        : this.props.width,
    };
  }
  componentDidMount = () => {
    ...
    return (
      ...
      >
        {children || (
          <View
            style={[
              modalDropdown.button,
              modalDropdown.itemWrapper,
              global.row,
            ]}
          >
            <Text
              style={[
                modalDropdown.buttonText,
                textStyle,
                {
                  padding: this.props.padding === 0 ? 0 : 5,
                  maxWidth: "90%",
                  fontWeight: "bold",
                },
              ]}
    ...
    if (showDropdown && this._buttonFrame) {
      ...
      return (
        ...
        >
          ...
          >
            <View style={modalDropdown.modal}>
              <View
                style={[
                  modalDropdown.dropdown,
                  dropdownStyle,
                  frameStyle,
                  {
                    height:
                      (33 + StyleSheet.hairlineWidth) *
                      (this.props.options.length < 8
                        ? this.props.options.length + 0.5
                        : 8),
                    marginTop: this.props.justForHeader,
  ...
  _calcPosition() {
    ...
    const dropdownHeight =
      ...
      StyleSheet.flatten(modalDropdown.dropdown).height;
    const bottomSpace =
  ...
  _renderItem = ({ item, index, separators }) => {
    ...
    const row = !renderRow ? (
      <Text
        style={[
          modalDropdown.rowText,
          dropdownTextStyle,
          highlighted && modalDropdown.highlightedRowText,
  ...
  _renderSeparator = ({ leadingItem = "" }) => {
    ...
    return <View style={modalDropdown.separator} key={key} />;
  };
  render() {
    return (
      <View {...this.props}>
